---
{"dg-publish":true,"permalink":"/34-rad-physics/mri/artefacts/off-resonance-effect/","dg-note-properties":{"type":["physics"],"modality":["MRI"],"status":"working"}}
---

> [!info] Key points
> 
> - **Definition:** spins precessing at a frequency different from the expected Larmor frequency for that voxel
> - **Scales with B0** → off-resonance effects are [[34_Rad_Physics/MRI/Misc/1.5T vs 3.0T MRI\|worse at 3T than 1.5T]] (chemical shift in Hz doubles)
> - **Four mechanisms:** B0 main field inhomogeneity, susceptibility, chemical shift (fat vs water), hardware
> - **Manifestations:** [[34_Rad_Physics/MRI/Fat suppression/Fat suppression (MRI techniques)\|fat-sat]] failure, chemical shift artefact, [[34_Rad_Physics/MRI/Artefacts/Banding artefact\|bSSFP banding]], EPI distortion/dropout
> - **Sequences most affected:** EPI >> [[34_Rad_Physics/MRI/Sequences/bSSFP\|bSSFP]] > GRE > spin echo (SE refocuses static off-resonance)
...
- Causing off-resonance for water-only acquisitions (in [[34_Rad_Physics/MRI/Fat suppression/Dixon (chemical-shift fat-water separation)\|dixon]])
...
**[[34_Rad_Physics/MRI/Fat suppression/Fat suppression (MRI techniques)\|Fat suppresion]] failure**
...
- **[[34_Rad_Physics/MRI/Fat suppression/Dixon (chemical-shift fat-water separation)\|Dixon]]:** depends on accurate fat-water frequency separation → **water-fat swap** when off-resonance shifts a voxel across the spectral midpoint
...
**[[34_Rad_Physics/MRI/Artefacts/Banding artefact\|bSSFP banding]]**
