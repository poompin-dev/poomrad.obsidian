---
{"dg-publish":true,"dg-path":"Rad/301_Disease/Mammo/Fat necrosis (Breast).md","permalink":"/rad/301-disease/mammo/fat-necrosis-breast/","tags":["breast","Pathology","mimic"]}
---
...
* **Mechanism:** Adipocyte death $\rightarrow$ release of fatty acids $\rightarrow$ saponification with calcium $\rightarrow$ inflammatory response (macrophages/giant cells) $\rightarrow$ fibrosis & scarring.
* **Key exam relevance:** Great mimic of carcinoma (clinical and radiological). Can present as a hard, fixed mass with skin tethering.
---
## Etiology
...
* **Specific sign:** **"Shifting echogenic bands"** (internal echoes that change orientation with patient position) $\rightarrow$ High specificity for liquefied fat/serum interface.
...
---
## Exam Pearls
* **Triple assessment:** If clinical exam is suspicious (hard/fixed) but imaging is classic benign fat necrosis $\rightarrow$ **Believe the imaging** (Discordance rule exception).
* **Biopsy pitfall:** Avoid biopsy of *obvious* oil cysts (risk of infection/non-healing). However, **biopsy is mandatory** if radiological features are indeterminate to exclude malignancy.
