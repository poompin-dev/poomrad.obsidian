---
{"dg-publish":true,"dg-path":"Rad/301_Disease/Chest/Mediastinum/Thymus chemical shift MRI.md","permalink":"/rad/301-disease/chest/mediastinum/thymus-chemical-shift-mri/"}
---

Normal/hyperplastic thymus has **microscopic fat mixed with water**, so it **loses signal on opposed-phase** GRE. Most thymic tumours (e.g. [[30_Rad Knowledge/301_Disease/Chest/Mediastinum/Thymoma\|Thymoma]]) have far less microscopic fat, so **little/no drop**.
## Acquire
...
> [!warning]
> Do not let one number bully you. If it is **nodular**, **growing**, very **FDG-avid**, or has **new extra-thymic disease**, call it indeterminate even if there is some drop. (Some mimics like **[[30_Rad Knowledge/301_Disease/Chest/Mediastinum/Thymolipoma\|Thymolipoma]]** can also suppress on OP.)
