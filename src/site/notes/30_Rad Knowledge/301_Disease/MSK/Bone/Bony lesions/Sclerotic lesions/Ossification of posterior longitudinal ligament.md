---
{"dg-publish":true,"dg-path":"Rad/301_Disease/MSK/Bone/Bony lesions/Sclerotic lesions/Ossification of posterior longitudinal ligament.md","permalink":"/rad/301-disease/msk/bone/bony-lesions/sclerotic-lesions/ossification-of-posterior-longitudinal-ligament/","tags":["spine","neuro","msk"]}
---
...
* **Epidemiology:**
    ...
    * **Age:** > 50 years.
* **Associations:**
    * **[[30_Rad Knowledge/301_Disease/MSK/Bone/Bony lesions/Sclerotic lesions/Diffuse idiopathic skeletal hyperostosis\|DISH]]:** Strongest association (~50% overlap).
    * **Metabolic syndrome:** DM, obesity (same as DISH).
    * **[[30_Rad Knowledge/301_Disease/MSK/Joint/Inflammatory joint diseases/Seronegative Spondyloarthropathy/Ankylosing spondylitis\|Ankylosing spondylitis]]:** Rare, but can co-exist.
...
* **Trauma risk:**
    ...
    * *Mechanism:* Stiff spine (DISH) + Narrow canal (OPLL) = **[[30_Rad Knowledge/301_Disease/Neuro/Spine/Trauma/Central cord syndrome\|Central cord syndrome]]** or catastrophic cord injury.
...
* **Classification (Tsuyama Classification):**
    1.  **Continuous:** Long flowing lesion over multiple vertebrae.
    2.  **Segmental:** Patches behind each vertebral body (discontinuous).
    3.  **Mixed:** Combination of continuous and segmental.
    4.  **Localised:** Confined to the intervertebral disc level (circumscribed).
### MRI
* **Signal:**
...
* **Appearance:**
    ...
    * **Lucent line:** A thin layer of connective tissue _between_ the OPLL and the dura.
...
* **Significance:**
	- **If the double layer is PRESENT:**
	    ...
	    - _Why?_ The surgeon cannot "peel" the OPLL off the dura because the dura _is_ the bone. Attempting to remove it anteriorly will rip the dura open.
	    - _Management:_ Surgeon usually switches to a **posterior approach** (laminoplasty) to avoid touching the anterior mass.
