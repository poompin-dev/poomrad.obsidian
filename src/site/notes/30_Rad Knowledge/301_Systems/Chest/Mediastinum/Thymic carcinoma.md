---
{"dg-publish":true,"dg-path":"Rad/301_Systems/Chest/Mediastinum/Thymic carcinoma.md","permalink":"/rad/301-systems/chest/mediastinum/thymic-carcinoma/","tags":["thymus"],"dg-note-properties":{"system":["chest"],"type":["disease"],"tags":["thymus"]}}
---

> [!summary]
> **High-grade malignant thymic epithelial tumour**. Compared with [[30_Rad Knowledge/301_Systems/Chest/Mediastinum/Thymoma\|thymoma]], it more often shows **infiltrative invasion**, **nodal metastases**, and **distant spread**, so prognosis is generally worse.
## Clinical
...
- Look for distant metastases: **pleural nodules/effusion**, pulmonary metastases
### MRI
- Helps assess **pericardial and vascular invasion** when CT equivocal
### FDG PET/CT
- **FDG-avid**; useful for **staging** (nodes + distant disease) and response assessment
