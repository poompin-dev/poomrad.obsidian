---
{"dg-publish":true,"dg-path":"Rad/301_Systems/Chest/Mediastinum/Thymus chemical shift MRI.md","permalink":"/rad/301-systems/chest/mediastinum/thymus-chemical-shift-mri/"}
---
...
> [!warning]
> Do not let one number bully you. If it is **nodular**, **growing**, very **FDG-avid**, or has **new extra-thymic disease**, call it indeterminate even if there is some drop. (Some mimics like **[[30_Rad Knowledge/301_Systems/Chest/Mediastinum/Thymolipoma\|Thymolipoma]]** can also suppress on OP.)
