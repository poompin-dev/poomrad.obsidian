---
{"aliases":null,"tags":["thorax","grading"],"dg-publish":true,"dg-path":"Rad/301_Systems/Chest/Pulmonary sarcoidosis/Scadding staging.md","permalink":"/rad/301-systems/chest/pulmonary-sarcoidosis/scadding-staging/","dgPassFrontmatter":true,"dg-note-properties":{"aliases":null,"tags":["thorax","grading"]}}
---

## Overview
The Scadding staging system (1961) is the standard method for classifying intrathoracic **[[30_Rad Knowledge/301_Systems/Chest/Pulmonary sarcoidosis/Pulmonary sarcoidosis\|Pulmonary sarcoidosis]]** based on **Chest Radiograph (CXR)** findings.
...
> [!warning] Critical Exam Trap: Stage $\neq$ Severity
...
> * A patient with **Stage II** may have severe active alveolitis, profound hypoxia, and rapidly declining diffusion capacity ($D_{LCO}$).
> * *Exam Tip:* Never assume a higher stage equals "sicker" patient.

> [!note] Progression logic
> The stages generally progress from I $\to$ III, but patients do not necessarily move sequentially.
...
* **Stage I:** Strongly associated with **[[30_Rad Knowledge/301_Systems/Chest/Pulmonary sarcoidosis/Löfgren syndrome\|Löfgren syndrome]]** (BHL + Erythema Nodosum + Arthralgia). High rate of spontaneous remission.
