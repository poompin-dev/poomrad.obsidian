---
{"dg-publish":true,"dg-path":"Rad/301_Systems/Ped/Pediatric neoplasm/INRG Staging System (INRGSS) & Image-Defined Risk Factors (IDRFs).md","permalink":"/rad/301-systems/ped/pediatric-neoplasm/inrg-staging-system-inrgss-and-image-defined-risk-factors-idr-fs/"}
---

> [!summary] Core idea
Pre-treatment, **imaging-based staging** for [[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Neuroblastoma\|Neuroblastoma]], designed so patients can be staged *before* any surgery or biopsy.  
It pairs with **IDRFs** to predict surgical risk and guide whether upfront resection is safe.

Although ultrasound is generally the first-line imaging modality for paediatric patients presenting with a palpable mass, if [[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Neuroblastoma\|Neuroblastoma]] is suspected and needs detailed evaluation, **CT or MRI** is the recommended imaging modality for complete assessment of the primary lesion at diagnosis.
## INRGSS stages
...
- Tumour extending into **two contiguous ipsilateral compartments**  
  (neck–chest, chest–abdomen, abdomen–pelvis) = **IDRF by itself**.
