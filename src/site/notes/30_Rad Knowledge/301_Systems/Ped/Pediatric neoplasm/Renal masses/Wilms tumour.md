---
{"aliases":["Nephroblastoma"],"ped":true,"path":["neoplasm"],"type":["disease"],"system":["GU"],"dg-publish":true,"dg-path":"Rad/301_Systems/Ped/Pediatric neoplasm/Renal masses/Wilms tumour.md","permalink":"/rad/301-systems/ped/pediatric-neoplasm/renal-masses/wilms-tumour/","dgPassFrontmatter":true,"dg-note-properties":{"aliases":["Nephroblastoma"],"ped":true,"path":["neoplasm"],"type":["disease"],"system":["GU"]}}
---

## Epidemiology & context
- Peak: early childhood (peak 3-4 years); can be bilateral/synchronous or metachronous.
- Associations: 
	- Nephrogenic rests ([[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Renal masses/Nephroblastomatosis\|Nephroblastomatosis]])
	- [[31_Medical knowledge/Genetics/Tumor predisposition syndromes/WAGR\|WAGR]]
	- Beckwith–Wiedemann
	- Denys–Drash
## Clinical clues
- Painless abdominal mass
- Abdominal pain, haematuria, anaemia; possible renin-mediated hypertension.
...
### CT
- Heterogeneous soft-tissue mass arising from kidney; **calcification uncommon** (cf. [[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Neuroblastoma\|Neuroblastoma]]).
...
- Bilateral disease or multifocality suggests background **[[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Renal masses/Nephroblastomatosis\|nephrogenic rests]]**.
...
- **[[30_Rad Knowledge/301_Systems/GU/Kidney/Renal masses/Renal cell carcinoma\|Renal cell carcinoma]] (older child/adolescent):** consider if atypical age or calcified solid mass.
