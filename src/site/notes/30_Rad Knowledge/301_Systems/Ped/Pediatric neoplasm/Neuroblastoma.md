---
{"path":["neoplasm"],"ped":true,"type":["disease"],"dg-publish":true,"dg-path":"Rad/301_Systems/Ped/Pediatric neoplasm/Neuroblastoma.md","permalink":"/rad/301-systems/ped/pediatric-neoplasm/neuroblastoma/","dgPassFrontmatter":true,"dg-note-properties":{"path":["neoplasm"],"ped":true,"type":["disease"]}}
---

## Key points
- The most common solid **extracranial** malignancy in the paediatric population (still rare: ~1–3 per 100,000 per year).
- Part of the [[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Neuroblastic tumour spectrum\|Neuroblastic tumour spectrum]] (neural crest–derived [[30_Rad Knowledge/301_Systems/MSK/Soft tissue/Soft tissue tumor/Sarcoma/Small round blue cell tumours\|small round blue cell tumor]] of the sympathetic nervous system).
	- Can arise anywhere along the **sympathetic chain** (cervical to pelvis).
	- Most commonly involves:
		- **Adrenal medulla**
		- Retroperitoneum
		- Posterior [[30_Rad Knowledge/301_Systems/Ped/Chest ped/Mediastinal masses (Ped)#Neuroblastoma\|mediastinum]]
- Onset commonly **< 2 years old** (younger than [[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Renal masses/Wilms tumour\|Wilms tumour]] which peaks around 3 years).
...
- Tends to **encase / engulf vascular structures** (aorta, IVC, renal vessels) rather than true intraluminal tumour thrombus as in [[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/Renal masses/Wilms tumour\|Wilms tumour]].
...
- **INRG / [[30_Rad Knowledge/301_Systems/Ped/Pediatric neoplasm/INRG Staging System (INRGSS) & Image-Defined Risk Factors (IDRFs)\|INRGSS]]** (International Neuroblastoma Risk Group Staging System)
...
#### Liver
Mainly observed in infants along with subcutaneous metastasis ([[70_Glossary/Ped/Blueberry muffin baby\|Blueberry muffin baby]]). 
