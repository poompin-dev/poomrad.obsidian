---
{"path":["neoplasm"],"system":["neuro"],"type":["disease"],"dg-publish":true,"dg-path":"Rad/301_Systems/Neuro/Brain/Sellar region/Pituitary adenoma.md","permalink":"/rad/301-systems/neuro/brain/sellar-region/pituitary-adenoma/","dgPassFrontmatter":true,"dg-note-properties":{"path":["neoplasm"],"system":["neuro"],"type":["disease"]}}
---
...
- Peak age of presentation is 4th-7th decades. 
	- In a **child with a diffusely enlarged, homogeneously enhancing gland**, think **[[30_Rad Knowledge/301_Systems/Neuro/Brain/Sellar region/Pituitary hyperplasia\|Pituitary hyperplasia]]** (e.g. primary hypothyroidism, puberty, end-organ failure) before adenoma.
## Clinical
### General
...
- Fluid-fluid levels can be present (ddx [[pituitary apoplexy\|pituitary apoplexy]])
- Strongly but heterogeneously enhance
- [[70_Glossary/Neuro/Posterior pituitary bright spot\|Posterior pituitary bright spot]] usually preserved
- Subtle dural thickening (a dural tail) can be seen (5-10%)
  Meningioma mimic, but adenoma tends to have more irregular invasion of cavernous sinus, no calcified/hyperostotic bone.
- Buzzwords
...
- [[Meningioma\|Meningioma]] of the diaphragmatic sellae
- Metastasis (uncommon)
	- Often **loss of posterior pituitary bright spot** + **early DI**.
	- Common primary includes:
		- breast
		- lung
		- systemic [[30_Rad Knowledge/301_Systems/Multisystem/Neoplasm/Hematologic malignancy/Lymphoma/Lymphoma signpost\|Lymphoma signpost]]
...
- Intrapituitary cysts (esp. cystic microadenoma)
	- [[30_Rad Knowledge/301_Systems/Neuro/Brain/Sellar region/Rathke’s cleft cyst\|Rathke’s cleft cyst]]:
	  Usually **non-enhancing**, may have **intracystic nodule**, often **midline**.
	- Pars intermedia cyst

> [!important] Exam pearls
> - **DI at presentation → think NOT adenoma** (met, [[30_Rad Knowledge/301_Systems/Neuro/Brain/Sellar region/Craniopharyngioma\|Craniopharyngioma]], LCH, hypophysitis).
...
> - **Physiologic / reactive [[30_Rad Knowledge/301_Systems/Neuro/Brain/Sellar region/Pituitary hyperplasia\|hyperplasia]]**:
