---
{"aliases":["NPH","Normal-pressure hydrocephalus"],"system":["neuro"],"type":["disease"],"modality":["CT","MRI"],"dg-publish":true,"dg-path":"Rad/301_Systems/Neuro/Brain/Normal pressure hydrocephalus.md","permalink":"/rad/301-systems/neuro/brain/normal-pressure-hydrocephalus/","dgPassFrontmatter":true,"dg-note-properties":{"aliases":["NPH","Normal-pressure hydrocephalus"],"system":["neuro"],"type":["disease"],"modality":["CT","MRI"]}}
---
...
### Evans index (EI)
1. Use **axial** CT/MR **aligned to AC–PC**.
2. Choose slice with **maximal frontal horn width** (often at/just above foramen of Monro).
3. Measure **A = maximal frontal horn span**.
4. On **same slice**, measure **B = maximal inner skull diameter**.
5. **EI = A / B** (report to two decimals).
### Callosal angle (CA)
1. Create **coronal** reformat **perpendicular to AC–PC**.
2. Use slice **through the posterior commissure** (bodies of lateral ventricles visible).
3. Draw lines **tangent to the superomedial ventricular walls**.
4. Measure the **inner angle** where lines meet **above the corpus callosum**.
___
## Practical use
