---
{"dg-publish":true,"dg-path":"Rad/303_Physics/MRI/Fat suppression/Dixon (chemical-shift fat-water separation).md","permalink":"/rad/303-physics/mri/fat-suppression/dixon-chemical-shift-fat-water-separation/","dg-note-properties":{"aliases":["Dixon"],"type":["physics"],"modality":["MRI"]}}
---

> [!info] Key points
> 
> - Chemical-shift based [[30_Rad Knowledge/303_Physics/MRI/Fat suppression/Fat suppression (MRI techniques)\|fat suppression]] using in-phase (IP) and opposed-phase (OP) images.
...
- **Bone marrow fat fraction**: [[30_Rad Knowledge/301_Systems/MSK/Bone/Bony lesions/Lytic lesions/Malignant/Multiple myeloma\|myeloma]], marrow replacement, benign vs malignant vertebral collapse
- **[[30_Rad Knowledge/301_Systems/GU/Adrenal gland/Adrenal adenoma\|Adrenal adenoma]]**: signal drop on OP (microscopic fat); qualitative OP/IP comparison suffices
...
> [!tip] Exam pearls
> - [[30_Rad Knowledge/301_Systems/GU/Adrenal gland/Adrenal adenoma\|Adrenal adenoma]]: signal-intensity index (SII) or adrenal-to-spleen ratio on IP/OP; microscopic fat = adenoma.
