---
{"dg-publish":true,"dg-path":"MSK/Bones/Bone marrow/Bone marrow conversion.md","permalink":"/msk/bones/bone-marrow/bone-marrow-conversion/","updated":"2026-01-11T19:08:10.000+07:00","dg-note-properties":{"type":["concept"],"status":"working"}}
---
...
- Epiphyses → diaphysis → distal metaphysis → proximal metaphysis (this pattern is reversed in [[30_MSK/Bones/Bone marrow/Red marrow reconversion\|Red marrow reconversion]]).
### Pattern by ages (tubular bones focused)
1. Infancy
	- Primary ossification centre (metadiaphysis) is filled with red marrow.
	- Secondary ossification centre (epiphyses and apophyses):
		- Un-ossified: cartilage → intermediate T1, high T2.
		- Ossified: yellow marrow within the ossification centres.
2. Childhood
