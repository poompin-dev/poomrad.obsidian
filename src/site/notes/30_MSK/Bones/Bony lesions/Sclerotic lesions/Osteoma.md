...
- Syndromic association with [[32_Multisystem/Genetics/Gardner syndrome\|Gardner syndrome]].
...
| :------------------------------ | :------------------------------------------------------------------------------------------------------------------------ |
| **[[38_Glossary/Exostosis\|Exostosis]]**               | Reactive/developmental outgrowth; usually **broad-based** (sessile); classic in external auditory canal ("surfer's ear"). |
| **Meningioma**              | Hyperostosis associated with meningioma arises from the **inner table** and involves the dura/meninges (en plaque).       |
| **[[30_MSK/Bones/Bony lesions/Lytic lesions/Benign/Fibrous dysplasia\|Fibrous dysplasia]]**       | "Ground-glass" matrix; expands the bone rather than growing *on* it; ill-defined margins.                                 |
| **[[30_MSK/Bones/Bony lesions/Sclerotic lesions/Osteoblastoma\|Osteoblastoma]]**           | > 2 cm; painful; rare in skull vault; lytic/mixed rather than purely sclerotic.                                           |
