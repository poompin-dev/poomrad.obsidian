---
{"dg-publish":true,"dg-path":"MSK/Bones/Bony lesions/Lytic lesions/Benign/Non-ossifying fibroma.md","permalink":"/msk/bones/bony-lesions/lytic-lesions/benign/non-ossifying-fibroma/","updated":"2026-08-03T08:18:51.000+07:00","dg-note-properties":{"type":["disease"],"aetiology":["malformation"],"ped":true,"aliases":["NOF","Fibroxanthoma","FCD","Fibrous cortical defect","Metaphyseal cortical defect"],"status":"working"}}
---

## Overview
* **Definition:** A common non-neoplastic, developmental defect of bone characterised by proliferation of benign fibrous tissue and histiocytes.
...
* **Syndromic association:** 
	* [[32_Multisystem/Genetics/Jaffe-Campanacci syndrome\|Jaffe-Campanacci syndrome]]: Rare syndrome but exam favourite; considered in multiple NOFs with NF1-like features.

---
## Anatomical distribution
* **Location:** Metaphysis $\rightarrow$ Metadiaphysis (migrates away from knee/joint with growth).
* **Bones:** Around the knee (80%).
...
* **Evolution:**
    1.  Starts at physis.
    2.  Migrates into diaphysis.
    3.  Fills in with sclerosis (ossifies) in adulthood $\rightarrow$ becomes a **"bone island"** or disappears.
### CT
* Usually unnecessary.
...
| :---------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[[30_MSK/Bones/Bony lesions/Lytic lesions/Benign/Chondromyxoid fibroma\|Chondromyxoid fibroma]]** (CMF)                         | **The main mimic.** CMF is usually more spherical/lobulated, lacks the natural history of migrating away from the physis, and is **T2 Bright** (myxoid). |
| **[[30_MSK/Bones/Bony lesions/Lytic lesions/Benign/Aneurysmal bone cyst\|Aneurysmal bone cyst]]**                                | **Fluid-fluid levels**; rapid expansion; much more aggressive cortical thinning.                                                                         |
| **[[Desmoplastic fibroma\|Desmoplastic fibroma]]**                                | Rare, locally aggressive; lacks the sclerotic rim; soft tissue mass.                                                                                     |
| **[[30_MSK/Bones/Bony lesions/Lytic lesions/Benign/Fibrous dysplasia\|Fibrous dysplasia]]**                                   | **Central** location; "ground glass" matrix; long segment involved; no sclerotic rim.                                                                    |
| **[[30_MSK/Bones/Bony lesions/Lytic lesions/Benign/Eosinophilic Granuloma\|Eosinophilic granuloma]]** | "Beveled edge"; rapid development; pain; no sclerotic rim (early).                                                                                       |
___
