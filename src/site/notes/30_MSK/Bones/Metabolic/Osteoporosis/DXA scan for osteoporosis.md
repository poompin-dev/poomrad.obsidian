---
{"dg-publish":true,"dg-path":"MSK/Bones/Metabolic/Osteoporosis/DXA scan for osteoporosis.md","permalink":"/msk/bones/metabolic/osteoporosis/dxa-scan-for-osteoporosis/","updated":"2026-08-03T08:18:51.000+07:00","dg-note-properties":{"type":["concept"],"aetiology":["metabolic"],"status":"working"}}
---
...
>     
> - **Severe (established) osteoporosis:** T-score ≤ −2.5 **plus** a typical [[30_MSK/Bones/Trauma/Atraumatic fracture/Insufficiency fracture\|Insufficiency fracture]] / [[30_MSK/Bones/Trauma/Special fracture/Fragility fracture\|Fragility fracture]]
>     
...
- Use **L1–L4** vertebrae.
**When to exclude a specific lumbar level?** → Artefacts that corrupt the BMD measurement, e.g.:
- Abdominal vascular calcification
...
**When to exclude spine measurement entirely?**
- When **fewer than two contiguous vertebrae** remain usable (cannot calculate a reliable L1–L4 mean).

Also assess vertebral morphology:
- Look for **vertebral deformity / collapse** → a [[vertebral insufficiency fracture\|vertebral insufficiency fracture]] both **confirms severe osteoporosis** (when T-score ≤ −2.5) and indicates a higher risk of future insufficiency fractures, especially of the hip.
### Hip
